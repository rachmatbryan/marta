...
- Once the requirements page has been installed, try running the nlpmain.py file with  `python marta.py`. If there are any missing packages, install them with pip and try rerunning them.
